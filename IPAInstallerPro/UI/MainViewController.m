...
- (void)setupDashboardHeader {
    ...
    UIView *stats = [[UIView alloc] initWithFrame:CGRectMake(24, 139, width - 48, 88)]; stats.backgroundColor = [UIColor colorWithRed:.065 green:.066 blue:.075 alpha:1]; stats.layer.cornerRadius = 20; stats.layer.borderWidth = 1; stats.layer.borderColor = [UIColor colorWithRed:.42 green:.08 blue:.09 alpha:.65].CGColor; [self.dashboardHeader addSubview:stats];
